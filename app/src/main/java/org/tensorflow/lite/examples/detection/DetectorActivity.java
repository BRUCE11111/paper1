...
return result;
  ...
  protected synchronized void processImage() {
    ...
    //croppedBitmap=Bitmap.createBitmap(croppedBitmap,0,0,croppedBitmap.getWidth(),croppedBitmap.getHeight(),matrix_person,false);
    ImageUtils.saveBitmap(croppedBitmap,"2.png");
           ...
           // cropCopyBitmap = Bitmap.createBitmap(croppedBitmap);
            ...
            for (final Classifier.Recognition result : results) {
              ...
              if (location != null && result.getConfidence() >= minimumConfidence  &&result.getTitle().equals("person")) {
                ...
                Matrix matrix_person=new Matrix();
...
//                    192,
//                    192,
//                    tracker.sensorOrientation,
//                    false);
//               matrix_person.invert(matrix_person);
//
//
//                rebitmap=Bitmap.createBitmap(rebitmap,0,0,rebitmap.getWidth(),rebitmap.getHeight(),matrix_person,false);

                //Bitmap person_bitmap=Bitmap.createBitmap(rebitmap,0,0,192,192,matrix_person,false);
